...
export default class GesRecWebPart extends BaseClientSideWebPart<IGesRecWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IGesRecProps> = React.createElement(
      GesRec,
      {
        description: this.properties.description,
        complaintsAppUrl: this.properties.complaintsAppUrl,
        servicingAppUrl: this.properties.servicingAppUrl,
        reportsUrl: this.properties.reportsUrl,
          ...
          groups: [
            {
              ...
              groupFields: [
                ...
                PropertyPaneTextField('complaintsAppUrl', {
                  label: strings.ComplaintsAppUrlFieldLabel
                }),
                PropertyPaneTextField('servicingAppUrl', {
                  label: strings.ServicingAppUrlFieldLabel
                }),
                PropertyPaneTextField('reportsUrl', {
                  label: strings.ReportsUrlFieldLabel
                }),
